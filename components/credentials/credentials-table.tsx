...
const credentialsData: CredentialItem[] = [
  {
    ...
    icon: "/team-collaboration-charts-graphs-business-analytic.jpg",
    state: "Published",
    updated: "20 Sep 2024",
    issued: 36,
  },
  {
    ...
    icon: "/leadership-communication-speech-bubble-microphone.jpg",
    state: "Published",
    updated: "16 Sep 2024",
    issued: 17,
  },
  {
    ...
    icon: "/artificial-intelligence-brain-circuit-academic-gra.jpg",
    state: "Published",
    updated: "16 Sep 2024",
    issued: 17,
  },
      ...
      <div>
        {credentialsData.map((credential, index) => (
          <div key={credential.id}>
            ...
            {index < credentialsData.length - 1 && <div className="border-b border-[rgb(208,224,255)]" />}
          </div>
        ))}
      </div>
    </div>
